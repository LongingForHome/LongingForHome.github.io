...
mw.kalturaPluginWrapper(function(){
	...
	mw.PluginManager.add( 'h5pLink', mw.KBaseComponent.extend({
        ...
        constructButton: function() {
        	...
        	$ (".topBarContainer").append(' ', $("<button class=\"btn pull-right\" data-order=\"1\"><img src=\"https://longingforhome.github.io/kaltura/playerPlugins/h5pLink/h5p_logo.png\"></button>").on('click', function(e) {$('#h5pModal').show();var copyLink = document.getElementById("h5pLink");copyLink.select(); document.execCommand("copy")}));     	
